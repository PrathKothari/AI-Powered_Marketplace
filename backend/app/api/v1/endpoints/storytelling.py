...
async def _generate_story_response(
    ...
    *,
    ...
    generated_narration_audio_path: Optional[str] = None,
    tone: str = "premium",
    ...
    result = await run_in_threadpool(
        ...
        generated_narration_audio_path=generated_narration_audio_path,
    )
...
async def generate_video(
    ...
    artisan_name: Optional[str] = Form(None),
    location: Optional[str] = Form(None),
    brand_name: Optional[str] = Form(None),
    generated_narration_audio_path: Optional[str] = Form(None),
...
async def generate_story_pipeline(payload: StoryVideoRequest):
    ...
    return await _generate_story_response(
        ...
        price=payload.price,
        product_type=payload.product_type or payload.art_style,
        artisan_name=payload.artisan_name,
        location=payload.location or payload.state_of_origin,
        brand_name=payload.brand_name,
        generated_narration_audio_path=payload.generated_narration_audio_path,
        tone=payload.tone,
